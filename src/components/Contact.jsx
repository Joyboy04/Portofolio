  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_p55efr1',
      {
        ...
        to_email: 'raihanrevikasya12@gmail.com',
      ...
      >
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <button type="submit" className="bg-tertiary py-3 px-8 outline-none w-fit text-white font-bold shadow-md shadow-primary rounded-xl mt-5">
